...
description: Upgrade applications from the version 1 HeaderLayout API to the version 2 Header API.
---
...
[Back to the README](https://github.com/mortalkiller/filament-page-header/blob/2.x/README.md)
