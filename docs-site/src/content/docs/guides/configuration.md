...
description: Configure identity, metadata, record context, responsive modes and reusable page headers.
---
...
For the simple product shown in the README, see variant 12 in the [standalone gallery](https://github.com/mortalkiller/filament-page-header/tree/2.x/workbench/app/Pages/HeaderGallery.php). It uses `image()`, two native actions and three metadata entries; the demo panel selects an indigo primary color.
